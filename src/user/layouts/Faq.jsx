              ...
              <div id="accordion-collapse" data-accordion="collapse">
                <div className="mb-8">
                  <h3 id="accordion-collapse-heading-1">
                    ...
                    >
                      <span className="text-blue-900">Apa itu Parentify?</span>
                ...
                <div className="mb-8">
                  <h3 id="accordion-collapse-heading-2">
                    ...
                    >
                      <span className="text-blue-900">Kenapa harus menggunakan Parentify?</span>
                ...
                <div className="mb-8">
                  <h3 id="accordion-collapse-heading-3">
                    ...
                    >
                      <span className="text-blue-900">Apakah Parentify mudah digunakan?</span>
                ...
                <div className="mb-8">
                  <h3 id="accordion-collapse-heading-4">
                    ...
                    >
                      <span className="text-blue-900">Apa saja fitur utama yang ditawarkan oleh Parentify?</span>
                ...
                <div className="mb-8">
                  <h3 id="accordion-collapse-heading-5">
                    ...
                    >
                      <span className="text-blue-900">Bagaimana cara menghubungi tim dukungan Parentify?</span>
