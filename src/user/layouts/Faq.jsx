              ...
              <div key={index} className="mb-8">
                <h3 id={`accordion-collapse-heading-${index}`}>
                  ...
                  >
                    ...
                    <svg data-accordion-icon className={`w-6 h-6 shrink-0 transform transition-transform text-sky-900 duration-300 ${activeIndex === index ? "rotate-180" : ""}`} fill="currentColor" viewBox="0 0 20 20">
