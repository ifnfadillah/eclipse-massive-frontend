...
// const SectionMitra = () => {
//   return (
//     <div className="sectioMitra">
//       <section className="bg-slate-50 dark:bg-gray-900">
//         <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
//           <div className="mx-auto max-w-screen-lg text-center mb-16 lg:mb-24">
//             <h2 className="mb-4 text-5xl tracking-tight font-extrabold text-gray-900 dark:text-white">Mitra Kami</h2>
...
//                 <div className="ml-4 text-xl text-gray-600">Mitra Pertama</div>
//               </div>
