...
const NavbarHome = () => {
  ...
  return (
    <nav className={`bg-gradient-to-t from-sky-900 to-sky-600 sticky top-4 md:mx-24 mx-8 border-blue-200 dark:border-gray-600 dark:bg-gray-900 ${isDropdownOpen ? "rounded-3xl" : "rounded-full"} shadow-lg z-50`}>
      ...
      <div ref={dropdownRef} id="mega-menu-full-dropdown" className={`mt-1 shadow-sm rounded-b-3xl dark:bg-gray-900 transition-all duration-300 ${isDropdownOpen ? "max-h-screen opacity-100" : "max-h-0 opacity-0 overflow-hidden"}`}>
