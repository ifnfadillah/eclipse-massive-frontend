...
const TableKomunitas = ({ data, setData, itemName }) => {
    // Pop Up Dialog Hapus
                ...
                <div className="overflow-x-auto" id="searchResults">
                    <table className="w-full text-sm text-left text-gray-500">
                        <thead className="text-sm text-white font-primary font-medium bg-sky-700">
                            <tr>
                                <th scope="col" className="px-8 lg:py-6 py-3">No</th>
                                <th scope="col" className="px-8 lg:py-6 py-3">Nama Komunitas</th>
                                <th scope="col" className="px-24 lg:py-6 py-3">
